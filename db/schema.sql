...
insert into hero_gates (section_slug, media_id, x, y, width) values
  ('trabajos', '11111111-1111-1111-1111-111111111111', 1605, 1110, 340),
  ('bio', '22222222-2222-2222-2222-222222222222', 1935, 1020, 280),
  ('textos', '33333333-3333-3333-3333-333333333333', 1320, 1560, 360),
  ('exposiciones', '44444444-4444-4444-4444-444444444444', 2385, 315, 300),
  ('archivos', '55555555-5555-5555-5555-555555555555', 390, 2010, 270),
  ('contacto', '66666666-6666-6666-6666-666666666666', 3210, 2145, 250)
